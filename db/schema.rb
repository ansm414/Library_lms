...
ActiveRecord::Schema[7.0].define(version: 2022_04_29_110857) do
  ...
  create_table "due_amounts", force: :cascade do |t|
    t.bigint "issued_book_id", null: false
    t.integer "fine"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "paid", default: false
    t.index ["issued_book_id"], name: "index_due_amounts_on_issued_book_id"
  end
  ...
  add_foreign_key "due_amounts", "issued_books"
